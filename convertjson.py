...
class JSONIFY:
        ...
        def jsonify_face(self,csvface,csvcenter) ->dict:
                ...
                # csv_face_data.index = csv_face_data['frameId']
                print(csv_face_data)
                frame_id = []
                x1 = []
                y1 = []
                x2 = []
                y2 = []
                for  i in range(0,len(csv_face_data)):
                        frame_id.append(csv_face_data['frameId'][i])
                        x1.append(csv_face_data['x1'][i])
                        y1.append(csv_face_data['y1'][i])
                        x2.append(csv_face_data['x2'][i])
                        y2.append(csv_face_data['y2'][i])
